...
export const trimLeft = (str: string) =>
  toString(str).replace(RX_TRIM_LEFT, "");

// Remove Trailing white space from a string
export const trimRight = (str: string) =>
  toString(str).replace(RX_TRIM_RIGHT, "");

// Remove leading and trailing white space from a string
export const trim = (str: string) => toString(str).trim();

// Lower case a string
export const lowerCase = (str: string) => toString(str).toLowerCase();

// Upper case a string
export const upperCase = (str: string) => toString(str).toUpperCase();
